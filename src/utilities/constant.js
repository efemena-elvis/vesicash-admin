...
const API_ENVIRONMENT = process.env.VUE_APP_VESICASH_ENVIRONMENT;
...
export const VESICASH_API_ENVIRONMENT = API_ENVIRONMENT;
export const VESICASH_API_VERSION = API_VERSION;
