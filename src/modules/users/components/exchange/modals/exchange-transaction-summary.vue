  ...
  >
    ...
    <template slot="modal-cover-body">
      <div class="modal-cover-body">
        ...
        <ModalListItem title="Initial amount" :value="summary.initial_currency" />
        <ModalListItem title="Final amount" :value="summary.final_currency" />
        <ModalListItem title="Exchange rate" :value="summary.rate" />
        <ModalListItem v-if="summary.date" title="Date" :value="summary.date" />
      </div>
    </template>
...
import ModalListItem from "@/shared/components/modal-list-item";
