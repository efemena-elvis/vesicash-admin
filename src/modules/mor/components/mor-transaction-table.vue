...
export default {
  ...
  components: {
    ...
    MORTableRow: () =>
      import(
        /* webpackChunkName: "mor-module" */ "@/modules/mor/components/mor-transaction-table-row"
      ),
  },
  ...
  computed: {
    ...mapGetters({
      getMORTransactions: "mor/getMORTransactions",
    }),
  ...
  data() {
    return {
      ...
      paginatedData: {},
      paginationPages: {},
      empty_message: "No past records of mor transactions",
    };
  },
  ...
  methods: {
    ...mapActions({
      fetchMORTransactions: "mor/fetchMORTransactions",
    }),
